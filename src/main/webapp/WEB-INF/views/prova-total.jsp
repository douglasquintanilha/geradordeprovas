...
<body>
	...
	<form:form action="correcao-prova" method="GET"
		commandName="questao">
		<c:forEach items="${listaQuestoes}" var="questao" varStatus="i">
			...
			<input type="radio" name="alternativas[${i.index}]" value="${listaAlternativas[i.index*5].descricao}">
				${listaAlternativas[i.index*5].descricao}<br />
				<input type="radio" name="alternativas[${i.index}]" value="${listaAlternativas[i.index*5+1].descricao}">
				${listaAlternativas[i.index*5+1].descricao}<br />
				<input type="radio" name="alternativas[${i.index}]" value="${listaAlternativas[i.index*5+2].descricao}">
				${listaAlternativas[i.index*5+2].descricao}<br />
				<input type="radio" name="alternativas[${i.index}]" value="${listaAlternativas[i.index*5+3].descricao}">
				${listaAlternativas[i.index*5+3].descricao}<br />
				<input type="radio" name="alternativas[${i.index}]" value="${listaAlternativas[i.index*5+4].descricao}">
